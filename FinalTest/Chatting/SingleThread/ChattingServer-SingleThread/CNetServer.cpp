...
unsigned int WINAPI CNetServer::AcceptThread(void* arg)
{
...
unsigned int WINAPI CNetServer::NetworkThread(void* arg)
{
	CNetServer* pNetServer = (CNetServer*)arg;
...
unsigned int WINAPI CNetServer::SendThread(void* arg)
{
	CNetServer* pNetServer = (CNetServer*)arg;
...
unsigned int WINAPI CNetServer::ReleaseThread(void* arg)
{
	CNetServer* pNetServer = (CNetServer*)arg;
	long undesired = 0;
