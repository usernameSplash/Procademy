...
private:
	Session* TrySessionAccess(const SessionID sessionId);
	void ReturnSessionAccess(Session* session);
	void IncrementSessionUseCount(Session* session);
	void DecrementSessionUseCount(Session* session);
